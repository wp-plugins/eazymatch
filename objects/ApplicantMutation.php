...
class emol_ApplicantMutation {
	...
	*/
	function setApplicant( $applicantId = null , $intakedate = null , $availablefrom  = null , $availableto = null , $title = null , $healthcarereference = null, $linkedinrequesttoken = null){
	...
	* @param mixed $gender
	*/
	function setPerson( $personId = null, $firstname = null , $middlename = null , $lastname  = null , $birthdate = null, $gender = null){
		$this->Person = array(
			'id' => $personId,
			'firstname' => $firstname,
			'lastname' => $lastname,
