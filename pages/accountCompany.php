...
class EmolCompanyAccountPage
{
	...
	* Class constructor
	*/
	function EmolCompanyAccountPage($slug , $function='' ){
	...
	*/
	function getNAWContent(){
		...
		*/
		...
		/**companySize**/
		$size = '<select name="companysize_id" class="emol-select">';
		...
		/**branches**/
		$branche = '<select name="branche_id" class="emol-select">';
		...
		$accountHtml .= '
				...
				<tr>
					...
					<td>
						...
						<input type="text" class="emol-text-input" name="address[1][street]" value="'.@$comp['Preferedaddress']['street'].'" /> 
						<input type="text" class="emol-text-input emol-small validate[required,custom[onlyNumber],length[0,5]]" name="address[1][housenumber]" id="housenumber" value="'.@$comp['Preferedaddress']['housenumber'].'" /> 
						<input type="text" class="emol-text-input emol-small" name="address[1][extension]" id="extension" value="'.@$comp['Preferedaddress']['extension'].'" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" class="emol-text-input" name="address[1][zipcode]" id="zipcode" value="'.@$comp['Preferedaddress']['zipcode'].'" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" class="emol-text-input" name="address[1][city]" id="city" value="'.@$comp['Preferedaddress']['city'].'" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<input type="text" class="emol-text-input" name="phonenumber[phonenumber]" id="phonenumber" value="'.@$comp['Preferedphonenumber']['phonenumber'].'" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<input type="text" class="emol-text-input" name="email[email]" id="email" value="'.@$comp['Preferedemailaddress']['email'].'" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" class="emol-text-input" name="coc" id="coc" value="'.@$comp['coc'].'" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<textarea type="text" class="emol-textarea" name="profile" id="profile">'.strip_tags($comp['profile']).'</textarea>
					</td>
				</tr>
				<tr>
					<td>
	...
	function getJobContent(){
		...
		if(count($jobs) > 0){
			foreach($jobs as $job){
				...
				if(is_null($job['startpublished'])) $job['startpublished'] = '-'; else $job['startpublished'] = date('d-m-Y',strtotime($job['startpublished']));
				if(is_null($job['endpublished'])) $job['endpublished'] = '-'; else $job['endpublished'] = date('d-m-Y',strtotime($job['endpublished']));
	...
	*/
	function saveNAW($companyId){
		...
		ob_clean();
		header('location: /'.get_option( 'emol_company_account_url' ).'/naw/');
		exit();
	}
