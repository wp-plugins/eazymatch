...
(function ($) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            remote: "Deze waarde is niet goed.",
            email: "Vul een geldig e-mail adres in.",
            url: "Vul een geldige url in.",
            date: "Vul een datum in (dd-mm-yyyy).",
            dateISO: "Vul een geldige (ISO) datum in.",
            number: "Voer een geldig nummer in.",
            digits: "Vul enkel numerieke waarden in.",
            creditcard: "Vul een geldig creditcard nummer in.",
            equalTo: "De ingevulde waarde komt niet overeen.",
            accept: "Incorrect.",
            maxlength: $.validator.format("Gebruik maximaal {0} karakters."),
            minlength: $.validator.format("Vul minimaal {0} karakters in."),
            rangelength: $.validator.format("Vul een waarde tussen {0} en {1} karakters lang."),
            range: $.validator.format("Vul een waarde in tussen {0} en {1}."),
            max: $.validator.format("Vul een waarde onder de {0} in. "),
            min: $.validator.format("Vul een waarde groter dan {0} in.")
        },
